    ...
    <Swiper.Item key={index}>
      <div className=" w-[330px] bg-[white] rounded-[10px] py-[15px] m-[auto] mb-[14.25px]">
        <div className=" flex justify-between pl-[7.5px] pr-[18.67px] h-[45px]">
          <div className=" font-bold text-[15px]">{value.uiElement.mainTitle.title}</div>
          <div className=" text-[16px] text-[#939ba1]">{value.uiElement.mainTitle.titleDesc}</div>
        </div>
        <div>
              ...
              <div key={index} className=" flex pt-[10px] pl-[7.5px]">
                ...
                <div className=" flex pl-[12.25px] pr-[21.38px] items-center text-[12px]">
                  ...
                  <div className=" w-[150px]">
                    <p className=" text-[13px]">{value.uiElement.mainTitle.title}</p>
                    <p>{value.resourceExtInfo ? value.resourceExtInfo.artists[0].name : ''}</p>
                  </div>

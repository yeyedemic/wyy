...
export default function Hot() {
  ...
  const items = data.map((value, index) => (
    <Swiper.Item key={index} style={{ height: '128.73px' }}>
      <div
        className=" w-[237px] rounded-[10px] py-[15px] px-[11.25px] box-border relative ml-[10.5px]"
      ...
      >
        ...
        <p className=" w-[157.57px] text-[white] leading-[18.75px] h-[37.5px] overflow-hidden">
  ...
  return (
    <Swiper indicator={() => null} slideSize={66} defaultIndex={0}>
      {items}
    </Swiper>
  );
}

...
function NewList() {
            ...
            return (
              <div key={index} className=" pt-[10px] pl-[7.5px] flex">
                ...
                <div className=" ml-[3.75px] pt-[10.69px] overflow-auto">
                  <p className=" text-[13.132px] w-[258px] text-[#3d465b] line-clamp-1">
                    {value.uiElement.mainTitle.title}
                  </p>
                  <p className=" h-[18px] text-[12px] text-[#79838f]">
                    {value.uiElement.subTitle ? value.uiElement.subTitle.title : ``}
                  </p>
                </div>
              </div>
            );
  ...
  return (
    <div className=" pb-[14.2576px]">
      <Swiper indicator={() => null} slideSize={90} defaultIndex={0}>
        {items}
      </Swiper>
    </div>
  );
